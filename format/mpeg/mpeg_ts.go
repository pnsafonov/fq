	...
	interp.RegisterFormat(
		...
		&decode.Format{
			...
			Dependencies: []decode.Dependency{
				{Groups: []*decode.Group{format.MpegTsPacket}, Out: &mpegTsMpegTsPacketGroup},
				{Groups: []*decode.Group{format.MpegTsPat}, Out: &mpegTsMpegTsPatGroup},
				{Groups: []*decode.Group{format.MpegTsPmt}, Out: &mpegTsMpegTsPmtGroup},
				{Groups: []*decode.Group{format.MpegPesPacket}, Out: &mpegTsMpegPesPacketGroup},
			},
		})
}
